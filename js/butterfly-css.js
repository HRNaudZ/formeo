 ...
 var btns = document.querySelectorAll(".modal-spawner");
 
 btns.forEach(btn =>{
    var modal = document.getElementById(btn.getAttribute("modal-id"));
    modal.parentElement.removeChild(modal);
    var inh = modal.innerHTML;
    modal.innerHTML = "";
    btn.modal = modal;
    var vi = modal.offsetWidth;
    var vy = modal.offsetHeight; 
    ...
    btn.addEventListener('click', function(){
        ...
        modal.style.height = "5px";
        modal.style.width = "5px";
        modal.style.opacity="0";
        modal.style.transition = "1s";

        modal.style.opacity="1";
        modal.style.backgroundColor="teal";
        var i = 5
        var j = 5
        var timer = window.setInterval(function(){
            ...
            if(i<200){
                i+=5.5;
                modal.style.minWidth = i+"px";
                
            }
            if(j<200){
                j+=5.5;
                modal.style.minHeight = j+"px";
            }
            if(i>=200 && j>= 200){
        ...
        var x = window.innerWidth/2 - modal.offsetWidth/2;
        var y = window.innerHeight/2 - modal.offsetHeight/2;
